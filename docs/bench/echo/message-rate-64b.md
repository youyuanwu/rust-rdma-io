...
(doorbells, completions) is the limiter. See [README.md](README.md) for the
scenario and how to run it. Other echo datasets:
...
[h1 § The fd wall](../h1/methodology.md#the-fd-wall-fixed).)

...
| | read-ring | 4.77M | 1.24 µs | 5.9 | 1760 µs | 4.2× | 1.3× | 70% |
| | credit-ring | 0.98M | 3.18 µs | 3.1 | 4731 µs | 1.6× | 3.5× | 14% |
| | **tcp** | 6.84M | 5.20 µs | 35.5 | 1339 µs | — | — | baseline |
| [large-payload 8 KiB](echo/large-payload-8kib.md)¹ | send-recv | ⏳ pending | — | — | — | — | — | — |
| | read-ring | 533k | 4.95 µs | ~2.6 | 619 µs | 1.8× | 1.4× | 118% |
| | credit-ring | ⏳ pending | — | — | — | — | — | — |
| | **tcp** | 452k | 8.91 µs | ~4.0 | 443 µs | — | — | baseline |
| [busy-poll `echo-busy`](echo/busy-poll.md)¹ ᵗ | send-recv | — N/A (no such mode) | — | — | — | — | — | — |
| | read-ring | 5.39M | 2.97 µs | 16 | 2381 µs | n/r | n/r | 117% |
| | credit-ring | — N/A (no such mode) | — | — | — | — | — | — |
| | **tcp** | 4.59M | n/r | 16 | n/r | — | — | baseline |
| [thread-per-core `echo-park`](echo/thread-per-core-park.md)¹ ᵗ | send-recv | — N/A (no such mode) | — | — | — | — | — | — |
| | read-ring | 4.96M | 1.52 µs | 8 | 1655 µs | 1.8× | n/r | 192% |
| | credit-ring | — N/A (no such mode) | — | — | — | — | — | — |
| | **tcp** | 2.59M | 2.81 µs | 8 | n/r | — | — | baseline |
...
| | read-ring | 833K | 67.4 µs | ~56 | 8567 µs | 1.1× | 0.6× | 113% |
| | credit-ring | 645.8K | 75.9 µs | n/r | n/r | 1.0× | n/r | 87% |
| | **tcp** | 740K | 74.1 µs | ~54.8 | 13527 µs | — | — | baseline |
| [payload 8 KiB](grpc/payload.md)³ | send-recv | 110K | 117 µs | ~13 | 2623 µs | 1.0× | 0.3× | 26% |
| | read-ring | 247K | 95 µs | ~24 | 1090 µs | 1.2× | 0.1× | 58% |
| | credit-ring | 202K | 94 µs | ~19 | 422 µs | 1.3× | 0.04× | 47% |
| | **tcp** | 427K | 118 µs | ~50 | 10167 µs | — | — | baseline |
...
| | read-ring | 582K | n/r | ~12 | 1656 µs | n/r | 0.2× | 75% |
| | credit-ring | 353K | n/r | ~7.3 | 766 µs | n/r | 0.1× | 45% |
| | **tcp1** | 780K | n/r | ~26 | 7371 µs | — | — | baseline |
...
| | credit-ring | 314K | n/r | ~10 | 874 µs | n/r | 0.2× | 72% |
| | **tcp1** | 437K | n/r | ~19 | 4247 µs | — | — | baseline |
| [thread-per-core `rh1-busy`](h1/thread-per-core.md)¹ ᵗ | send-recv | — N/A (no such mode) | — | — | — | — | — | — |
| | read-ring | 1461K | 10.9 µs | 16 | n/r | 2.1× | n/r | 423% |
| | credit-ring | — N/A (no such mode) | — | — | — | — | — | — |
| | **tcp1** | 345K | 22.8 µs | 16 | n/r | — | — | baseline |

...
| message-rate 64 B | read-ring | 4.77M | 1.24 µs | 5.9 | 1760 µs | 4.2× | 1.3× | 70% |
| message-rate 64 B | credit-ring | 0.98M | 3.18 µs | 3.1 | 4731 µs | 1.6× | 3.5× | 14% |
| message-rate 64 B | **tcp** | 6.84M | 5.20 µs | 35.5 | 1339 µs | — | — | baseline |
| [large-payload 8 KiB](echo/large-payload-8kib.md)¹ | send-recv | ⏳ pending | — | — | — | — | — | — |
| large-payload 8 KiB | read-ring | 533k | 4.95 µs | ~2.6 | 619 µs | 1.8× | 1.4× | 118% |
| large-payload 8 KiB | credit-ring | ⏳ pending | — | — | — | — | — | — |
| large-payload 8 KiB | **tcp** | 452k | 8.91 µs | ~4.0 | 443 µs | — | — | baseline |
| [busy-poll `echo-busy`](echo/busy-poll.md)¹ ᵗ | send-recv | — N/A (no such mode) | — | — | — | — | — | — |
| busy-poll `echo-busy` | read-ring | 5.39M | 2.97 µs | 16 | 2381 µs | n/r | n/r | 117% |
| busy-poll `echo-busy` | credit-ring | — N/A (no such mode) | — | — | — | — | — | — |
| busy-poll `echo-busy` | **tcp** | 4.59M | n/r | 16 | n/r | — | — | baseline |
| [thread-per-core `echo-park`](echo/thread-per-core-park.md)¹ ᵗ | send-recv | — N/A (no such mode) | — | — | — | — | — | — |
| thread-per-core `echo-park` | read-ring | 4.96M | 1.52 µs | 8 | 1655 µs | 1.8× | n/r | 192% |
| thread-per-core `echo-park` | credit-ring | — N/A (no such mode) | — | — | — | — | — | — |
| thread-per-core `echo-park` | **tcp** | 2.59M | 2.81 µs | 8 | n/r | — | — | baseline |
...
such mode. Best-config notes (e.g. read-ring's 8 KiB 24×8 peak, busy-poll's efficient
8-core ceiling) are on the detail pages.
...
| throughput 64 B | read-ring | 833K | 67.4 µs | ~56 | 8567 µs | 1.1× | 0.6× | 113% |
| throughput 64 B | credit-ring | 645.8K | 75.9 µs | n/r | n/r | 1.0× | n/r | 87% |
| throughput 64 B | **tcp** | 740K | 74.1 µs | ~54.8 | 13527 µs | — | — | baseline |
| [payload 8 KiB](grpc/payload.md)³ | send-recv | 110K | 117 µs | ~13 | 2623 µs | 1.0× | 0.3× | 26% |
| payload 8 KiB | read-ring | 247K | 95 µs | ~24 | 1090 µs | 1.2× | 0.1× | 58% |
| payload 8 KiB | credit-ring | 202K | 94 µs | ~19 | 422 µs | 1.3× | 0.04× | 47% |
| payload 8 KiB | **tcp** | 427K | 118 µs | ~50 | 10167 µs | — | — | baseline |
| [client CPU & memory 64 B](grpc/cpu-memory.md)¹ | send-recv | 196.3K | 65.3 µs | n/r | n/r | 1.1× | n/r | 91% |
| client CPU & memory 64 B | read-ring | 236.1K | 65.9 µs | n/r | n/r | 1.1× | n/r | 109% |
| client CPU & memory 64 B | credit-ring | 248.6K | 70.8 µs | n/r | n/r | 1.1× | n/r | 115% |
| client CPU & memory 64 B | **tcp** | 216.3K | 74.9 µs | n/r | n/r | — | — | baseline |
...
| throughput 64 B | read-ring | 582K | n/r | ~12 | 1656 µs | n/r | 0.2× | 75% |
| throughput 64 B | credit-ring | 353K | n/r | ~7.3 | 766 µs | n/r | 0.1× | 45% |
| throughput 64 B | **tcp1** | 780K | n/r | ~26 | 7371 µs | — | — | baseline |
| [large-payload 8 KiB](h1/large-payload-8kib.md)³ | send-recv | 308K | n/r | ~8 | 1380 µs | n/r | 0.3× | 70% |
| large-payload 8 KiB | read-ring | 410K | n/r | ~14 | 1954 µs | n/r | 0.5× | 94% |
| large-payload 8 KiB | credit-ring | 314K | n/r | ~10 | 874 µs | n/r | 0.2× | 72% |
| large-payload 8 KiB | **tcp1** | 437K | n/r | ~19 | 4247 µs | — | — | baseline |
| [thread-per-core `rh1-busy`](h1/thread-per-core.md)¹ ᵗ | send-recv | — N/A (no such mode) | — | — | — | — | — | — |
| thread-per-core `rh1-busy` | read-ring | 1461K | 10.9 µs | 16 | n/r | 2.1× | n/r | 423% |
| thread-per-core `rh1-busy` | credit-ring | — N/A (no such mode) | — | — | — | — | — | — |
| thread-per-core `rh1-busy` | **tcp1** | 345K | 22.8 µs | 16 | n/r | — | — | baseline |

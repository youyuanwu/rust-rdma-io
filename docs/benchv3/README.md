...
| Orchestration (`run_bench.sh` + Ansible playbooks) | [`tests/e2e/`](../../tests/e2e) | Deploys binaries/certs, launches server+client over the private link, fetches JSON results. |

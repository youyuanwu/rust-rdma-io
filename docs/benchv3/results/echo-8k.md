...
| -------------- | ------------------ | ---- | -------- | -------- | -------- | ----------- | ----- | ------------- | ------ |
| `send-recv` | `n/a` | `n/a` | `n/a` | `n/a` | `n/a` | `n/a` | `n/a` | `n/a` | `n/a` |
| `read-ring` (arm-park) | 179532 | 11.77 | 1368.0 | 2337.0 | 2883.0 | 43.91 | 7.88 | 87 | 1 |
| `read-ring` (busy-poll) | 314953 | 20.64 | 668.0 | 1896.0 | 2613.0 | 203.15 | 63.98 | 92 | 6 |
| `read-ring` (thread-per-core park) | 108255 | 7.09 | 2289.0 | 2385.0 | 2443.0 | 17.52 | 1.90 | 91 | 8 |
| `credit-ring` | 278451 | 18.25 | 542.0 | 1308.0 | 1744.0 | 21.91 | 6.10 | 84 | 0 |
| kernel baseline | 202251 | 13.25 | 1131.0 | 1901.0 | 2335.0 | 44.30 | 8.96 | 47 | 0 |

#### 4× vCPU · in-flight 64

> **SKU:** `Standard_E64bs_v6` (uksouth) · **vCPU:** 64 · **scenario:** echo · **payload:** 8 KiB · **connections:** 4× vCPU · **in-flight:** 64 · **duration/warmup:** 10 s / 3 s · **git commit:** `a3d99d0` · **date:** `20260725T010620Z`

| Transport path | Throughput (req/s) | Gbps | p50 (µs) | p95 (µs) | p99 (µs) | CPU/op (µs) | cores | peak RSS (MB) | errors |
| -------------- | ------------------ | ---- | -------- | -------- | -------- | ----------- | ----- | ------------- | ------ |
| `send-recv` | `n/a` | `n/a` | `n/a` | `n/a` | `n/a` | `n/a` | `n/a` | `n/a` | `n/a` |
| `read-ring` (arm-park) | 387487 | 25.39 | 2779.0 | 4771.0 | 5563.0 | 21.97 | 8.51 | 100 | 4 |
| `read-ring` (busy-poll) | 390069 | 25.56 | 3161.0 | 5379.0 | 6359.0 | 164.00 | 63.97 | 114 | 0 |
| `read-ring` (thread-per-core park) | `n/a` | `n/a` | `n/a` | `n/a` | `n/a` | `n/a` | `n/a` | `n/a` | `n/a` |
| `credit-ring` | 384807 | 25.22 | 3983.0 | 6339.0 | 8147.0 | 21.83 | 8.40 | 100 | 3 |
| kernel baseline | 444153 | 29.11 | 35263.0 | 56895.0 | 62431.0 | 10.26 | 4.56 | 48 | 0 |
...
| 4× vCPU | 1 | 179532 | 11.77 | 1368.0 | 2337.0 | 2883.0 | 43.91 | 7.88 | 87 | 1 |
| 4× vCPU | 64 | 387487 | 25.39 | 2779.0 | 4771.0 | 5563.0 | 21.97 | 8.51 | 100 | 4 |
| 4× vCPU | 512 | `n/a` | `n/a` | `n/a` | `n/a` | `n/a` | `n/a` | `n/a` | `n/a` | `n/a` |
...
| 2× vCPU | 512 | `n/a` | `n/a` | `n/a` | `n/a` | `n/a` | `n/a` | `n/a` | `n/a` | `n/a` |
| 4× vCPU | 1 | 314953 | 20.64 | 668.0 | 1896.0 | 2613.0 | 203.15 | 63.98 | 92 | 6 |
| 4× vCPU | 64 | 390069 | 25.56 | 3161.0 | 5379.0 | 6359.0 | 164.00 | 63.97 | 114 | 0 |
| 4× vCPU | 512 | `n/a` | `n/a` | `n/a` | `n/a` | `n/a` | `n/a` | `n/a` | `n/a` | `n/a` |
...
| 4× vCPU | 1 | 108255 | 7.09 | 2289.0 | 2385.0 | 2443.0 | 17.52 | 1.90 | 91 | 8 |
| 4× vCPU | 64 | `n/a` | `n/a` | `n/a` | `n/a` | `n/a` | `n/a` | `n/a` | `n/a` | `n/a` |
| 4× vCPU | 512 | `n/a` | `n/a` | `n/a` | `n/a` | `n/a` | `n/a` | `n/a` | `n/a` | `n/a` |
...
| 4× vCPU | 1 | 278451 | 18.25 | 542.0 | 1308.0 | 1744.0 | 21.91 | 6.10 | 84 | 0 |
| 4× vCPU | 64 | 384807 | 25.22 | 3983.0 | 6339.0 | 8147.0 | 21.83 | 8.40 | 100 | 3 |
| 4× vCPU | 512 | `n/a` | `n/a` | `n/a` | `n/a` | `n/a` | `n/a` | `n/a` | `n/a` | `n/a` |
...
| 4× vCPU | 1 | 202251 | 13.25 | 1131.0 | 1901.0 | 2335.0 | 44.30 | 8.96 | 47 | 0 |
| 4× vCPU | 64 | 444153 | 29.11 | 35263.0 | 56895.0 | 62431.0 | 10.26 | 4.56 | 48 | 0 |
| 4× vCPU | 512 | `n/a` | `n/a` | `n/a` | `n/a` | `n/a` | `n/a` | `n/a` | `n/a` | `n/a` |

...
| Transport path | Throughput (req/s) | p50 (µs) | p95 (µs) | p99 (µs) | CPU/op (µs) | cores | peak RSS (MB) | errors |
| -------------- | ------------------ | -------- | -------- | -------- | ----------- | ----- | ------------- | ------ |
| `send-recv` | 4052969 | 270.0 | 1161.0 | 2267.0 | 1.53 | 6.18 | 38 | 0 |
| `read-ring` (arm-park) | 4406701 | 218.0 | 634.0 | 1015.0 | 1.31 | 5.78 | 54 | 0 |
| `read-ring` (busy-poll) | 5625058 | 290.0 | 363.0 | 449.0 | 11.37 | 63.98 | 44 | 102 |
| `read-ring` (thread-per-core park) | 3662586 | 93.0 | 390.0 | 783.0 | 1.31 | 4.79 | 61 | 2 |
...
| Transport path | Throughput (req/s) | p50 (µs) | p95 (µs) | p99 (µs) | CPU/op (µs) | cores | peak RSS (MB) | errors |
| -------------- | ------------------ | -------- | -------- | -------- | ----------- | ----- | ------------- | ------ |
| `send-recv` | 14837 | 970.0 | 5259263.0 | 5263359.0 | 9.17 | 0.14 | 81 | 1 |
...
| 2× vCPU | 64 | 4052969 | 270.0 | 1161.0 | 2267.0 | 1.53 | 6.18 | 38 | 0 |
| 2× vCPU | 512 | 14837 | 970.0 | 5259263.0 | 5263359.0 | 9.17 | 0.14 | 81 | 1 |
...
| 2× vCPU | 64 | 5625058 | 290.0 | 363.0 | 449.0 | 11.37 | 63.98 | 44 | 102 |
...
| 2× vCPU | 64 | 3662586 | 93.0 | 390.0 | 783.0 | 1.31 | 4.79 | 61 | 2 |
| 2× vCPU | 512 | `n/a` | `n/a` | `n/a` | `n/a` | `n/a` | `n/a` | `n/a` | `n/a` |

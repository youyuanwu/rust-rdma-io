...
> **SKU:** `Standard_E64bs_v6` (uksouth) · **vCPU:** `__` · **scenario:** HTTP/1.1 · **payload:** 8 KiB · **connections:** 16× vCPU · **in-flight:** 1 · **duration/warmup:** `__` s / `__` s · **git commit:** `________` · **date:** `________`

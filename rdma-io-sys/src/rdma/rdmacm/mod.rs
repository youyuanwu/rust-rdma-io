...
pub union rdma_addr_0 {
    ...
    pub src_sin: bnd_linux::libc::r#in::sockaddr_in,
    pub src_sin6: bnd_linux::libc::r#in::sockaddr_in6,
...
pub union rdma_addr_1 {
    ...
    pub dst_sin: bnd_linux::libc::r#in::sockaddr_in,
    pub dst_sin6: bnd_linux::libc::r#in::sockaddr_in6,
